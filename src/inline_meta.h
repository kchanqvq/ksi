...
//Each item: _(__,id,symbol name,(require reset?,require dynamic memory?,have editing commands?),(list of input),(list of output),(list of event input),(list of event output))
...
#define INLINE_PORTS_MF(__,id,name,prop,in,out,ein,eout,...) \
        __(id,name,                                                     \
